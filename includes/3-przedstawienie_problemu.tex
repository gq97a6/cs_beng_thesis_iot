...
Proponowanym rozwiązaniem dla przedstawionych problemów jest stworzenie aplikacji mobilnej, która będzie pełnić funkcję uniwersalnego dashboardu do zarządzania urządzeniami IoT opartymi na protokole MQTT. Aplikacja ma na celu zapewnienie użytkownikom pełnej kontroli nad ich inteligentnymi urządzeniami, zwiększenie bezpieczeństwa i prywatności, a także poprawę wygody użytkowania dzięki centralizacji zarządzania.\\

Aplikacja będzie wykorzystywać protokół MQTT, który jest lekkim i wydajnym standardem komunikacji IoT. Umożliwia on lokalną wymianę danych między urządzeniami bez konieczności korzystania z serwerów producentów, co zwiększa niezależność użytkowników i minimalizuje ryzyko awarii wynikających z problemów zewnętrznej infrastruktury. Dzięki wsparciu dla MQTT użytkownicy będą mogli zarządzać swoimi urządzeniami w pełni lokalnie, co zapewni maksymalną ochronę prywatności, ponieważ dane nie będą opuszczać sieci domowej. Aplikacja umożliwi dodawanie, monitorowanie i sterowanie urządzeniami IoT podłączonymi do lokalnego brokera MQTT oraz tworzenie spersonalizowanych dashboardów dostosowanych do indywidualnych potrzeb.\\

Bezpieczeństwo użytkowników będzie priorytetem. Komunikacja między aplikacją a brokerem MQTT będzie szyfrowana, a użytkownicy będą mieli możliwość konfiguracji uwierzytelniania i autoryzacji dostępu do urządzeń, co dodatkowo zwiększy ochronę ich danych. Dzięki lokalnemu przetwarzaniu informacji, ryzyko naruszeń prywatności zostanie zminimalizowane.