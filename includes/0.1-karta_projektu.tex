...
\begin{center}
    \begin{tabularx}{1\textwidth} {| >{\arraybackslash}X |}
        ...
        \parbox[c][5em][c]{0.9\textwidth}{
            \textsl{Stworzenie aplikacji mobilnej z przeznaczniem na system operacyjny Android umożliwiającej
            zbudowanie własnego panelu sterowania inteligentnymi urządzeniami wykorzystując protokoł MQTT.}
        }
        \\
        \hline
        \parbox[c][2em][c]{\textwidth}{
