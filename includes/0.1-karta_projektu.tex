...
\begin{center}
    \begin{tabularx}{1\textwidth} {| >{\arraybackslash}X |}
        ...
        \parbox[c][5em][c]{0.9\textwidth}{
            \textsl{Stworzenie konkurencyjnego rozwiązania umożliwiającego sterowanie urządzeniami IoT z wykorzystaniem protokołu MQTT; Nauka programowania aplikacji mobilnych}
        }
        \\
        \hline
        \parbox[c][2em][c]{\textwidth}{
