...
\setlength{\cftbeforesubsubsecskip}{0.18em}
...
\include{includes/3-przedstawienie_problemu}
\newpage

\include{includes/4-faza_analizy}
\newpage

\include{includes/5-faza_projektowania}
\newpage

\include{includes/6-faza_implementacji}
\newpage

\include{includes/7-faza_testow}
\newpage

\include{includes/8-faza_utrzymania}
\newpage

\include{includes/9-prezentacja}
\newpage

\include{includes/10-podsumowanie}
\newpage

\include{includes/11-bibliografia}
\newpage

\include{includes/12-zalaczniki}
\newpage
